...
export const PAGE_TITLES: Record<string, string> = {
  ...
  '/displacement': 'Multi-Leg Analysis — Displacement Reporting',
  '/displacement/monthly': 'Multi-Leg Analysis — Monthly Details',
  '/displacement/departures': 'Multi-Leg Analysis — Departure Details',
